				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<form:input path="automobile.make" cssClass="form-control" />
						</div>
						<div class="form-group">
							<label for="model">Model</label>
							<form:input path="automobile.model" cssClass="form-control" />
						</div>
						<div class="form-group">
							<label for="year">Year</label>
							<form:input path="automobile.year" cssClass="form-control" />
						</div>
						<div class="form-group">
