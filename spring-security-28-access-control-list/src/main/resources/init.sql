...
insert into AUTO_USER (autoUserId, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, ROLE) values (null, 'ivgarcia@gmail.com', 'Ivan', 'Garcia', 'password', 'ivgarcia', 'ROLE_ADMIN');
