...
public class AppointmentController {
	...
	@PostAuthorize("hasPermission(#model['appointment'], 'read')") // used for ACL
	...
	@PostAuthorize("hasPermission(returnObject['appointment'], 'administration')") // usde for ACL
	public @ResponseBody Map<String, Object> confirm(@PathVariable("appointmentId") Long appointmentId) {

		Map<String, Object> response = new HashMap<>();
		response.put("appointment", this.appointmentRepository.findOne(appointmentId));
		response.put("action", "confirmed");
		return response;
	}
