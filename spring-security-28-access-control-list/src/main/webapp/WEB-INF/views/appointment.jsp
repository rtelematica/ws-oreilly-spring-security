	...
	<div class="container">
		...
		<ul class="list-group">
			...
			<li class="list-group-item">
				...
				<sec:authorize access="hasRole('USER') and principal.username == '${appointment.user.username}'">
					<a class="btn btn-default"
						href="<spring:url value="/appointments/cancel/${appointment.appointmentId}"/>" role="button">Cancel</a>
				</sec:authorize>
				
				<sec:authorize access="${!isValidUser} and principal.username == '${appointment.user.username}'">
					<a class="btn btn-default"
						href="<spring:url value="/appointments/cancel/${appointment.appointmentId}"/>" role="button">Cancel</a>
				</sec:authorize>
