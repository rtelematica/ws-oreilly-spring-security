...
-- using plain text pass pau
-- insert into users(username, password, enabled) values ('pau', 'pau', true);

-- using sha-256 pass pau
-- insert into users(username, password, enabled) values ('pau', '470adaa55fab37a1a00db983fcc022a1dbb13fc7361937f36cdc5f14de19f6ce', true);

-- using bcrypt pass pau
-- insert into users(username, password, enabled) values ('pau', '$2a$10$iykA289gd/0v9OOY7fBeN.xcUonlNgkb4CzPpg9ApFcN5KeGXMPiy', true);

-- using Pbkdf2PasswordEncoder pass pau
insert into users(username, password, enabled) values ('pau', '22624051033c4c66acb61070cf9c2ff76647e8e1ca2bfd34f8dc3f5960702616783502c447ae898a', true);


-- using plain text pass ilse
-- insert into users(username, password, enabled) values ('ilse', 'ilse', true);

-- using sha-256 pass ilse
-- insert into users(username, password, enabled) values ('ilse', 'a9be7536cde1ef845e6d57ec28b9a4cbd6da8566463b119d4c3be132e45da4a9', true);

-- using bcrypt pass ilse
--insert into users(username, password, enabled) values ('ilse', '$2a$10$iVEeQhWLmK51z6IZwXgxNucHEB3lxK78ed8.d524XmXRQlBQo2EP.', true);

-- using Pbkdf2PasswordEncoder pass ilse
insert into users(username, password, enabled) values ('ilse', '22af63fa7c7b98c317d5236c5ae725855e2815e562ccea1f910b36bae2ab5e21fd54e3749c14aa4a', true);

-- Registering authorities (no needed using groups)
